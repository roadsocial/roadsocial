...
class VideoLLM:
    def __init__(self, movel_v):
        ...
        self.tokenizer, self.model, self.image_processor, self.max_length = load_pretrained_model(self.pretrained, None, 'llava_qwen', device_map='auto')  #,overwrite_config=overwrite_config
        self.model.eval()
